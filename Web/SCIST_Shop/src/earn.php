...
<script src="https://cdnjs.cloudflare.com/ajax/libs/tocas/4.1.0/tocas.min.js"></script>
    ...
    <body>
                ...
                <div class="ts-row">
                    ...
                    <div class="column">
                        <div class="ts-wrap">
                            ...
                            <a class="ts-text is-undecorated" href="#!">目前 <span id="money"><?php echo $_SESSION['money'] ?></span> 元</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="ts-space is-big"></div>
        <div class="ts-container">
            <div class="ts-header is-large is-heavy">熱門工作</div>
            <div class="ts-space"></div>
            <div class="ts-grid is-4-columns">
                <div class="column is-truncated" onclick="earn1()">
                    <div class="ts-box">
                        <div class="ts-image">
                            <img src="1-1.png" />
                        </div>
                        <div class="ts-content">
                            <div class="ts-text is-truncated is-bold">幫 SCIST 發傳單</div>
                ...
                <div class="column is-truncated" onclick="earn2()">
                    <div class="ts-box">
                        <div class="ts-image">
                            <img src="1-1.png" />
                        </div>
                        <div class="ts-content">
                            <div class="ts-text is-truncated is-bold">幫 SCIST 演算法出題</div>
                            <span class="ts-text">$1</span>
                        </div>
                        <div class="ts-divider"></div>
                        <div class="ts-content">
                ...
                <div class="column is-truncated" onclick="earn3()">
                    <div class="ts-box">
                        <div class="ts-image">
                            <img src="1-1.png" />
                        </div>
                        <div class="ts-content">
                            <div class="ts-text is-truncated is-bold">幫 TICO 出題</div>
                            <span class="ts-text">$1000</span>
                        </div>
                        <div class="ts-divider"></div>
                        <div class="ts-content">
                            <div class="ts-row">
                ...
                <div class="column is-truncated" onclick="earn4()">
                    <div class="ts-box">
                        <div class="ts-image">
                            <img src="1-1.png" />
                        </div>
                        <div class="ts-content">
                            <div class="ts-text is-truncated is-bold">幫 TICO 工作</div>
                            <span class="ts-text">$23,000</span>
                        </div>
                        <div class="ts-divider"></div>
                        <div class="ts-content">
                            <div class="ts-row">
            ...
            <div class="ts-wrap is-center-aligned">
                <button class="ts-button is-circular" onclick="more();">查看更多賺錢工作</button>
            </div>
            <script>
                function more() {
                    alert("沒有東西啦！");
        ...
        <form action="real_earn.php" method="post" id="myform">
